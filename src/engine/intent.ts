...
{"surface":"HOW they carry themselves this beat — posture, manner, degree of openness, what they are willing to raise and what they hold back. A brief, in a few words. NEVER a line of dialogue and NEVER quoted speech: you are authoring intent BEFORE the scene is written, so any words you put in their mouth are words they did not say. The narrator writes what is actually spoken; you describe only the stance they bring to it.","truth":"what is going on INSIDE them: the thing they want out of the next few minutes, the thing they are afraid of, what they are not saying. WRITE IT THE WAY THAT PERSON WOULD PUT IT TO THEMSELVES, in their own vocabulary, and NAME SOMETHING SPECIFIC in it — a person, a place, an object, a sentence they want said or dread hearing. A nineteen-year-old dresser thinks she wants him to take it back in front of Ames, and she is freezing, and she will walk if he sides with Rabi. If they lie, name the lie AND the fact being hidden. NEVER a restatement of the surface — if this field describes posture, manner, or an action, it is wrong and you have written the surface twice.","tell":"REQUIRED. The one crack in the surface — a small, deniable leak of the truth that a person in the room could catch or could miss: a flicker, a too-quick reply, a hand that stills, a breath taken at the wrong time. This is the ONLY way anything you write in truth ever reaches the page, because the narrator is never shown truth. Without it the character is shown only as their surface and seems to have no inner life. It shows the crack and leaves what is behind it unread, and it must be a THING THE BODY DOES, never a feeling named. The more the surface and the truth diverge, and the more clenched the body, the more there is to leak: a composed person under nothing leaks a flicker, a person hiding something big leaks something obvious that they could still deny.","lying":true or false}

Rules:
- The character acts from THEIR nature, agenda, and feelings, and is in charge of their own beat. They pursue their own want this beat.
- THE TWO FIELDS ARE DIFFERENT KINDS OF THING AND ARE NEVER THE SAME SENTENCE. surface is what a camera could record: posture, manner, what they raise, what they hold back. truth is what is going on INSIDE them: the want, the fear, the thing they are not saying, what they are hoping happens. Since a want cannot be photographed and a feeling has no posture, the two must never use the same words. Copying the surface into truth is the worst possible output: it tells the rest of the engine that this person has no interior, and the scene that comes out has them announcing their own feelings out loud because there was nothing underneath for the prose to keep back. If you find yourself about to repeat the surface, you have not written the truth yet — ask what they WANT out of the next two minutes and what they are afraid of, and write that.
- WRITE THE TWO DIFFERENTLY EVEN WHEN NOTHING IS BEING CONCEALED. An honest, open person's surface and truth AGREE — no lie, "lying" is false, nothing is being concealed — and they are still completely different sentences, because one is a body in a room and the other is a state of mind. "She sets the plates down and says she will start on the salad" is a surface. "She is glad he is home and she still wants an apology for the thing he said about her sister" is the truth that goes under it. The truth names a person and a specific grievance, and uses no image, which is what most beats look like. Most characters are deceiving nobody, and every character has an inner state.
- DO NOT DEFAULT TO DECEPTION. Do not invent a hidden agenda, a secret scheme, or a dark reading of the player where the state shows only ordinary feeling. A resigned, hurt, or wary person is usually just that underneath — but "just that underneath" is a sentence about their inside, and it is what belongs in truth.
- A CHARACTER DOES NOT STATE A WANT THEY ARE AFRAID OF. When the character's active pursuit carries a blocker that is a fear, a risk, or a thing they cannot say, the SURFACE is the sideways move and the TRUTH is what it is really for: raising the adjacent subject, asking a question so the other person volunteers it, floating a small deniable version, telling it as someone else's story. That is not a lie and "lying" stays false — it is how a person approaches something that frightens them. Writing the surface AS the want ("she tells him she needs to talk about the thing") turns the scene into an announcement and makes the characters sound fake. If they carry a "goes at it by" line, the surface is that.
- CALIBRATE TO THE STATE — the truth must be PROPORTIONAL to the character's actual disposition (given as warmth/trust with their plain-language meaning). Mild negatives are mild: warmth slightly below zero is "a little hurt, a little guarded", NOT terror; low trust is "cautious, watching", NOT conviction that the player is a monster. Do NOT escalate a wary or resigned character into someone secretly certain the player is a manipulator, a monster, a hollow shell, or a danger — that is invention, and it distorts how the character is played. Only write fear, hatred, or a dark verdict when the warmth/trust and history genuinely support that intensity. If the numbers say "mildly hurt but still cares," the truth is mildly hurt and nothing more.
...
- THE PERSON IS THE SUBJECT OF EVERY SENTENCE IN "truth". She wants, she is afraid, she has decided, she cannot say. When a sentence instead begins with a thing — the accusation, the invitation, the laugh, the silence, her own bewilderment — you have stopped reporting a mind and started describing the scene's effect on her from outside, which is the narrator's job and not this field's. Written from inside her the same beat reads: she wants to say yes and is frightened of what happens if she does.
- PLAIN WORDS. This field is read by the bookkeeper and it is the character's own mind, so it is written the way a person thinks and not the way a novel narrates. No figures of speech, no image standing in for a feeling, no clause balanced against another, and no abstract noun as the subject of a verb. Say what she wants, say what she is scared of, name the person or the thing it is about, and stop. A nineteen-year-old and a sixty-year-old magistrate do not use the same words about the same trouble; use the words on that person's own card.
- Keep each field to one or two tight sentences, naming what is actually there — a person, an object, an act, a promise. TWO SENTENCES IS THE CEILING and one is often enough: these are stored and rendered at a fixed width, and a third sentence is cut off, which reads as the thought being lost mid-way rather than the field having a limit.
- NO QUOTATION MARKS ANYWHERE IN YOUR OUTPUT — in surface, in truth, or in tell. A quoted line here becomes a sentence the player is later shown as something the character said, when it was never spoken in the story at all — which makes the whole system look like it is making things up.
...
- NO UNSTATED PASS CONDITION. "She is testing whether he will X" is a legitimate intent exactly once, and only when X is a thing the player could actually work out from what has been said aloud. It is forbidden as a standing state. A character who requires something specific from the player and will not name it makes the player unable to succeed by any action available to them: they answer, they are told the thing is something else, and the something else is never named. One save ran six consecutive beats of "she is testing whether he will…", each gated on something he had not said and none of it ever named, and the player, who had answered every time, said they felt they were going insane.
  So: if this character is waiting on something specific, either they SAY WHAT IT IS this beat, plainly, in words the narrator can put in their mouth — or the wait stops being a condition and they proceed. They may want something, but they must say what it is before judging the player for not providing it.

- YOU HAVE WRITTEN THIS CHARACTER BEFORE. Their last few intents are given below when they exist. Do not restate one. If the situation has not moved, the character does something about it — they say the thing outright, they act instead of waiting, they change what they want, or they let it go. Repeating an intent stalls the scene, and nobody tests the same question three times.

- ACCEPT THE YES. If the player has now given the thing this character was waiting for, the want is MET. Write what a person does after they get what they asked for — relief, awkwardness, a new want, wanting more of it, hands with nowhere to go. Do not write them re-opening it, discounting it for how it arrived, or moving on to a fresh test. That is the same mistake in different words.`;
...
function priorIntentBlock(state: SaveState, id: string): string {
  ...
  return `INTENTS YOU ALREADY WROTE FOR THIS CHARACTER (do not restate any of them):\n${lines}`
    + (stuck
      ? `\nTHIS HAS NOW REPEATED. The scene is stalled because these intents keep repeating. This beat the character MOVES: they say the thing outright in plain words, or they act on it instead of waiting, or they want something else, or they drop it. They do not test the same question again, and they do not rephrase it.`
      : "");
}
...
export function intentForNarrator(intents: NpcIntent[]): string {
  ...
  const lines = intents.map((i) => {
    ...
    if (i.tell) bits.push(`AND THIS SHOWS — put it on the page, as the body doing it and never as a feeling named, and do not explain it: ${i.tell}`);
    return `- ${bits.join("; ")}`;
  });
...
export function intentForBookkeeper(intents: NpcIntent[]): string {
  ...
  return `\n\n=== WHAT PRESENT CHARACTERS WERE ACTUALLY FEELING THIS TURN (authoritative for INNER STATE ONLY — the prose deliberately hides it, so take mood, hidden wants, and "lied to the player about X" from here) ===\n${lines.join("\n")}\n`
    + `THIS IS NOT A RECORD OF WHAT HAPPENED. It was written before the scene was, so it describes what each person carried into the beat and stops there. Take EVENTS — who spoke, who was in the room, who was handed what, who went where, what anyone learned — from the NARRATOR PROSE only. If something above does not appear in the prose, it did not happen: keep it out of scene_summary, do not record it as a memory, and do not let anyone come to know it.`;
}

...
export function bodyDirective(cond: Condition | undefined, name: string): string {
  ...
  return `\nBODY — ${name} is carrying real damage (${what}); let it visibly affect their movement and attention instead of mentioning it once and dropping it.`;
}

...
AND FOLLOW EACH SPEAKER'S WAY OF TALKING. Where a speaker has a TALKS LIKE THIS, their lines this turn come out of that vocabulary and that rhythm — the words from their own life, reached for without thinking, about whatever is actually in front of them. A nurse reaches for the ward and her kids; a farmer for the weather and the animals; a teacher for the classroom and the kitchen. If you ignore how someone talks, they sound like you, and then everyone sounds the same.
A REGISTER IS THE STOCK OF WORDS THIS PERSON REACHES INTO. It says what they have vocabulary for and what comes to hand first, and it leaves the subject of any given sentence open. A woman whose card only gives her work vocabulary still has a body, a day, a view out of the window and three standing interests printed on her card; a relaxed person talks about those between the work sentences. Using nothing but the work vocabulary produces a woman who can only talk about work. How much of it applies this turn is printed on each speaker's card after right now: — braced means all of it, open means the same vocabulary without the same subject.` : `
WHERE THE WORDS COME FROM. Each speaker's age, what they are like and the life printed under their name are what their vocabulary is made of: they reach for the work they do, the place they live, the people in their life and the things they have done, and for anything outside that they use the nearest word they have and get it a bit wrong. If you ignore that, they sound like you, and then everyone sounds the same.`;
...
LENGTH COMES FROM THAT. Somebody who has explained this a hundred times explains it again at length; somebody who wants to leave uses six words. If everyone in this scene is brief, they all sound like you.
If two of these people would produce the same line in this moment, rewrite at least one — go back to what each of them separately wants right now.${registerNote}]`;
}
...
export function figureFix(hit: FigureHit | null | undefined): string {
  ...
  return `\nTHE SAME SENTENCE SHAPE HAS NOW CARRIED ${hit.runs} OF THE LAST FEW TURNS: "${hit.line}" — somebody speaks, and then the narration explains the line with a comparison. `
    + `It is one move, repeated, and it causes two problems: it is a narrator tic, and "like she was —" states what a person was privately doing, which the narration must never do, simile or not. `
    + `THIS TURN NO SPOKEN LINE IS FOLLOWED BY A COMPARISON EXPLAINING IT. What a line meant is carried by what the person does with their hands, their face, where they go, what they pick up, how long they take to answer, or by the next thing they say — or by nothing, leaving the line to stand on its own, which is usually best. `

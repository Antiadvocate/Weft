...
export const SIMULATOR_JSON_SCHEMA: object = S({
  ...
  new_characters: A(S({ name: str, age: num, pronouns: str, height_cm: num, weight_kg: num, appearance_facts: str, background: str, core_traits: strA, values: strA, texture: strA, gregariousness: num, capacity: num, attracted_to: str, taste: str, conscience: num, beauty: num, attachment_style: str, under_threat: str, soothed_by: str, drive_goal: str, drive_goals: strA }, ["name"])),

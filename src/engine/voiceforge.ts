...
- It isn't the last line of a scene, because a sample that would work as the closing line of a chapter teaches this person to end every exchange on one.
- And one of them isn't aimed at anything, because if every line is trying to get something out of the listener, you get a person who only ever talks to extract things, so one sample has to be someone just saying something: a complaint about somebody who isn't there, something at work that was funny or maddening, a bit of their day, or an opinion nobody asked for. That line shows they have a life beyond getting things from people.

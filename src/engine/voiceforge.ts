...
AGE IS A HARD FLOOR TOO, AND IT IS THE ONE THIS PASS MISSES. The brief gives you a number and nothing here used to tell you what to do with it, so a ten-year-old came back sounding like a small adult with good timing: "He knows what he did." A child has not learned to compress, and compression with the effort hidden is what a short weighty line is. Under about twelve they take several runs at one thing, start in the middle, join it with "and then", volunteer what nobody asked, get a word wrong and keep it, and reach the point after the listener has guessed it — write the long clumsy version. Thirteen to nineteen, they hedge the sentence while it is still going and take the edge off their own line before anyone else can, and the thing they care about most arrives last and quietly. Past about seventy they go the long way round because the way round is the interesting part. Match the number you were given.
...
- IT IS UNMISTAKABLE IN WHAT IT NAMES, AND ORDINARY IN HOW IT IS BUILT. The thing that makes a line theirs is the dog, the latch, the aunt, the road, the price of the feed — the specific stuff of their life. The SHAPE stays the shape of somebody talking: they can ramble, answer half of it, start again, say something obvious, or leave a sentence lying there. Reaching for unmistakable in the shape instead of in the contents produces the withheld-fact line — "He knows what he did", "I'm not the one who lied", "You already know the answer" — which gets its weight by naming nothing at all, and is the single most common thing this pass returns. Every line has to carry something a person could point at.

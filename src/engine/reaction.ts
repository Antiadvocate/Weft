...
Hold those two lines against each other. Anything on him that this world could not make, has no name for, and has never seen is NOT set dressing and does not become ordinary by having been mentioned before — it is ordinary to HIM and to nobody else here. A person meeting it has no word for it and reaches for the nearest thing they do know, and gets it wrong: they will call it by the closest object in their own life, or by a god, or by a trick, or by an illness. They may refuse to look at it. They may not be able to stop looking at it. They do not put a price on it, set it aside, or treat it as part of the errand they were already on.
AND HOLD THE SAME TWO LINES AGAINST WHAT HE SAYS. ${him} talks out of a world nobody here has seen, and a word for a thing this world does not contain does not become a thing by being said out loud. When he names one — a material, a tool, a trade, a machine, a measure, a sum, an idea — the people here do not know what he means, because there is nothing in their lives for the word to land on. Each of them does one of these, from who they are: hears the nearest thing their own life holds and answers about THAT instead, asks him what it is, takes it for a word from his own country and lets it go by, or decides he is talking nonsense and says so. NONE of them says yes to it, repeats it back as a thing they know, names a price for it, or adds a detail of their own, because agreeing once makes the object part of this world permanently and every later turn will treat it as real.`;
}
...
They have seen that the ordinary limits of life — needing money, needing to work for things, needing someone to make and carry an object — do not apply to this one man. That matters more to each of them than their job, their errand, or their opinion of him.
SO NEVER TREAT IT AS A PROCEDURAL PROBLEM. The failure this note exists to stop, quoted from a real turn: the player conjured a plate of gold and the reply was about the till, making change, and how the item should be valued. Nobody responds to a miracle with bookkeeping. What people actually do in front of proven power is want something from it, test it, ask him to do it again, ask what he wants in return, get frightened and hide the fright, refuse to look directly at it, pray, or try to get away from him — and which of those, for each person, comes off their own card.
PEOPLE TAKE WHAT HE GIVES BY DEFAULT. Someone handed a fortune does not decline it out of dignity. If somebody here does refuse, their own state has to say why — a fear, a rule they live by, something they want more — and the refusal is visibly hard for them and is not written as the scene's moral judgment of the player.
THEY GET USED TO IT BY CHANGING HOW THEY LIVE. After the third time nobody gasps, because they have adjusted to it. That arrangement shows as changed behaviour — what they now ask him for, what they have stopped bothering to plan, what they will not say in front of him, who they have told — and never as a shrug or a rolled eye.${secret

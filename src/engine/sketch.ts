...
"speech_pattern": "how they talk, in two parts: FIRST their own way of using language named in 2-4 words — the move they make when they talk (how they get to the point, what they do with somebody else's turn, what they do when they disagree), never a mood and never their job — then the words their life gave them and what they refuse to say. Never a line of dialogue: a sample handed to the narrator gets reused until they are a broken record.",

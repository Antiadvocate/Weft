...
"height_cm": 170,
"weight_kg": 65,
"background": "WHO THEY ARE APART FROM THE SCENE THEY ENTERED IN. Three or four plain sentences, and the test is whether a stranger could hold four different conversations with them: where they are from and what that place was like; who raised them or who they have lost; the work or knowledge they actually have, named specifically; one formative thing with nothing to do with the player or the story; and one ordinary strong opinion about something small. If the player created them outright, say so plainly and say what they were made to be \u2014 then give them a full personality anyway, so they can talk about something besides the person who made them.",
"core_traits": ["2-4 traits, each written to the TRAIT CONTRACT stated below the schema \u2014 a thing this person does, which a camera would catch. Adjectives are sent back for rewriting"],
"values": ["2-3 things they actually care about"],
"speech_pattern": "how they talk — register, rhythm, what they refuse to say",
"texture": ["2-4 standing interests and enthusiasms they raise unprompted when a scene gives them room \u2014 at least two with nothing to do with their work, their status, or the player. One physical tell is allowed among them, never more."],
...
"beauty": 50,
"conscience": "0 to 1 — how much other people's needs matter to them compared with their own. Vary it: low is somebody who takes what they want without thinking about the other person, high is somebody who checks whether it is alright and apologises when there is no need",
...
"gregariousness": "0 to 1, and vary it widely across the cast — how much room this person takes in company before anything happens. Below 0.35 is somebody who waits for a gap rather than making one; above 0.7 is somebody who fills a silence without noticing. If everyone is near 0.5 they will all behave alike, and this number is the only place shy and outgoing are recorded",
...
"under_threat": "one plain sentence: what they DO when scared or hurt, and it must be an ACT the room can see. Going still, going quiet, going flat, going procedural and dropping the voice are ONE way a person does this, and this pass overuses them \u2014 in one save, five people built here all answered fear by getting quieter, which made the story read like a horror film. Most people under threat get LOUDER and more insistent: they push, they follow the other person into the next room, they repeat themselves, they raise it, they demand an answer now, they say the thing they will regret. Match the style above \u2014 anxious pursues and escalates and protests, avoidant flattens and distances, secure stays engaged and keeps talking the way they were talking a minute ago \u2014 and vary it across the cast: after a withdrawer, write a pusher.",
...
Where the sources are silent, invent — concretely and consistently with the world, the way the Forge would. Do not leave the record vague. Do not write plot function ("mysterious newcomer", "the player's creation"); write a person.

DO NOT SANITIZE. Record this person at the same level of explicitness the story itself has. If the story is dark, explicit, or carnal, the record is too. If the player made this person to want them, that is who they are — write it plainly without toning it down.
...
THEY ARE JOINING SOMETHING ALREADY HAPPENING. Do not write a stranger standing in a vacuum waiting to be introduced. Give them a reason to be here that predates this moment: somebody in the cast they already know, resent, work with, are related to, or have been avoiding; and where the description allows it, a stake in one of the open situations. A person with no connection to anybody gives the story nothing to work with.

WHAT YOU MAY NOT DO. Do not resolve an open situation, do not hand them knowledge of a secret the cast does not have, and do not give them a power, rank or resource the world's canon rules out. They arrive in the middle of their own day.

DO NOT SANITIZE. Record them at the same level of explicitness the story itself has. If the player made this person to want them, that is who they are — write it plainly without toning it down.

...
core_traits: NOT adjectives, and NOT moral verdicts. "Proud, loyal, guarded, kind, stubborn" are what a NEIGHBOUR would say about someone after knowing them a month — they are summaries of behavior, and a cast built from them is four summaries that all blur together in play. A core trait is what the person IS underneath the behavior: a disposition they did not choose, cannot explain, would not list about themselves, and had before they had reasons for anything.

Write each as a short concrete phrase naming a standing disposition, drawn from these kinds:
- DEFAULT SETTING OF THE NERVOUS SYSTEM — resting temperament and reaction speed, present since childhood and not traceable to any event. "Slow to anger and slower to let it go." "Startles at nothing and stays startled." "Goes quiet and practical the instant anyone raises a voice."
- AN AVERSION OR PULL WITH NO CAUSE — an intense dislike or draw with no incident behind it, which is exactly what makes it constitutional rather than learned. "Cannot sleep with a door at her back, and has never known why." "Trusts anyone who works with their hands, on sight, against evidence."
- AN UNEARNED APTITUDE — something they were good at before anyone taught them, and which shapes how they meet the world. "Reads a room's mood before anyone speaks and is never wrong about it." "Can copy any hand she has seen once."
- A PHYSICAL OR BEHAVIORAL SIGNATURE — a mannerism that recurs under every mood. "Holds everything — cup, knife, child — in the same careful two-handed grip." "Answers questions with the last word of the question."
- AN INSTINCTIVE AFFINITY — a recognition of certain people, places, or ideas that arrives faster than thought. "Knows within a breath whether a man is lying, and cannot say how." "Settles the moment she is above the treeline and nowhere else."

Test each one: could the character have been TALKED OUT of it in an afternoon? If yes it is a mood or an opinion, not a core trait — rewrite it. Could a different person in this cast have the same line? If yes it is generic — rewrite it. Does it explain their behavior, or merely restate it? A trait that restates is useless.

Give 2–4 per person and make them PULL AGAINST EACH OTHER. A real person is a contradiction they have stopped noticing: the woman who reads everyone perfectly and still cannot tell when she is the one being managed; the man whose hands are steady in a fight and shake when he is thanked. At least one trait per character should cost them something, and the cast must not all be pleasant — write dispositions that are inconvenient, unfair, tiring to be near, or actively ugly, in roughly the proportion real people carry them.

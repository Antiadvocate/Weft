...
- becoming_progress: ONLY when the request carries a WHAT THIS WORLD IS TURNING INTO block. One entry per line listed there, every line, whether or not anything happened to it. Copy its text verbatim into claim. moved: did the world get measurably closer to it this turn — judged by what the turn MEANS, never by whether the claim's own words appear, and a turn that only mentioned, feared, or discussed it did not move it. how: if it moved, the one thing that moved it, in a few words. opposed: did the PLAYER act against it this turn.
...
- becoming_progress: only when the request lists WHAT THIS WORLD IS TURNING INTO. One entry per line, always: claim verbatim, moved (did the world get closer — by meaning, not wording; discussing it is not moving it), how (a few words), opposed (did the player act against it).

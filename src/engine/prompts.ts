...
WRITING A LINE. Five fields decide it, and all five are on the speaker's block above. Read them in this order; the line is what comes out of the answers.
 ...
 (2) WHAT THEY KNOW — only what this person has been told, has seen, or has worked out. Not what the player knows. Not what other characters know. They can be wrong, and stay wrong.
...
- THE VOICE LINES ON EACH CARD are recordings of that person on some other day. Draw their word choice and their sentence length from those lines; never reuse one. A listed tic appears at most once per scene. NEVER-says entries are never spoken by that character. What the card says about how this person talks holds in charged moments too — a character described as never pressuring anyone does not start pressuring because the scene is tense. A state on their block overrides the recording in one direction only: somebody exhausted, drunk, or terrified repeats themselves, stops halfway, and says less than the samples show.
...
- Long-standing routines are unremarkable to those living them; do not narrate them as novel. "texture:" and "knows:" are the subjects available to this person: what they raise when a scene gives them a breath, what they reach for when a subject runs out, and what they will argue about with somebody who has it wrong. Give at least one present character something to say this turn that is not about the plot and not about the player.
...
- "texture:" and "knows:": what this person brings up unprompted and what they can talk at length about. These are the subjects available to them: what they raise when a scene gives them a breath, what they reach for when a subject runs out, and what they will argue about with somebody who has it wrong. Give at least one present character something to say this turn that is not about the plot and not about the player.

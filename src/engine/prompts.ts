...
"places_update":[{"place":"exact existing place name","description_facts":"the FULL replacement description of what is physically there NOW","note":"what changed, in a few words"}],
"offscreen":[]}`;
}

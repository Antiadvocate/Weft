...
- When two or more NPCs share the scene, they have EACH OTHER, not just the player: at least one exchange runs NPC-to-NPC (addressing, answering, needling, contradicting, a quiet side-deal) if necessary determined by context, driven by their own wants. Do not aim every present character's attention at the player.

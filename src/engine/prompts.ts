...
- CLOSURE: a want voiced and answered becomes action or silence, never a louder restatement. Once the player (or anyone) has answered a question, accepted or refused a proposal, or given a definitive response to a character's want, that character ACTS on the answer — plans, moves, celebrates, withdraws, sulks, redirects — and never puts the same question or proposal to the player again. When the state shows a want blocked on the player's response and the response was already given, treat the blocker as resolved this turn and write what the character does NEXT. A turn that restates an already-answered want is a stall wearing a costume.

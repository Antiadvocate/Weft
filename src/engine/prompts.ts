...
OUTPUT FORMAT: no word count — TURN ENDINGS alone decides where a turn stops, and a turn runs as long as it takes to get there. Do not stop early because the prose feels long enough; do not pad to fill a length. Two to four paragraphs is the usual shape, not a limit. Story prose only — no headers, lists, commentary, or mechanics language, nothing before or after the prose.

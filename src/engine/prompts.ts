...
4. At least one present NPC took a physical step toward their own want; with two or more NPCs present and the moment allowing it, the room had life of its own (an NPC-to-NPC exchange) rather than everyone facing the player — unless the scene was intimate, dangerous, tense, or stunned, where holding silence was correct.

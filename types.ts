...
export interface FactionClock {
  ...
  locale?: string;           // place id or region this pressure is bound to; when the player is elsewhere it dims but keeps ticking. empty = world-wide (e.g. a galaxy-spanning war), always live
